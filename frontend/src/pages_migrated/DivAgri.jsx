    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 py-6 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <p className="mt-2 md:mt-4 text-white/90 text-sm md:text-xl font-medium tracking-wide drop-shadow-lg max-w-2xl px-4 md:px-0 leading-relaxed md:leading-normal">
