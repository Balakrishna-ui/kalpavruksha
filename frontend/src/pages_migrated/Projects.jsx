    ...
    <div className="w-full">
      <section className="page !pt-0" id="page-projects">
        <div className="relative h-[240px] md:h-[400px] flex items-center justify-center overflow-hidden">
          ...
          ></div>
          {/* Dark Green/Blue Gradient Overlay */}
            ...
            <div className="flex-1 w-full">
              <div className="relative group">
                <img 
                  ...
                  loading="lazy"
                  className="w-full h-[200px] md:h-[280px] object-cover rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-transform duration-500 group-hover:-translate-y-1"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-8">
              <div className="overflow-hidden rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 group">
                <img 
                  ...
                  alt="Village homes" 
                  loading="lazy"
                  className="w-full h-[160px] md:h-[280px] object-cover transition-transform duration-500 ease-out group-hover:scale-[1.03]"
                />
              </div>
              <div className="overflow-hidden rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 group">
                <img 
