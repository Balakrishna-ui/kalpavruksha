    ...
    <div className="w-full bg-[#fdfdfd] overflow-hidden font-inter selection:bg-gold/30 selection:text-forest">
      ...
      <section className="px-6 pt-8 md:pt-[20px] pb-8 md:pb-12">
        <motion.div 
          ...
          viewport={{ once: true }}
          variants={fadeUp}
          className="max-w-[1200px] mx-auto bg-[#f0f9f4] rounded-[2rem] p-6 md:p-12 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 shadow-lg border border-emerald-100"
        >
          {/* Left Content */}
          <div className="flex-1 space-y-4 md:space-y-6">
            ...
            <motion.h2 variants={fadeUp} className="text-2xl md:text-5xl font-bold text-[#0B1F4D] tracking-tight text-center md:text-left">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row sm:items-center gap-4 pt-4">
              <motion.a
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-[#25D366] text-white px-6 py-3 md:py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors shadow-md shadow-[#25D366]/20 w-max"
              >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            variants={zoomIn}
            className="bg-white p-4 md:p-5 rounded-[2rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] flex flex-col items-center shrink-0 border border-gray-50"
          >
            <motion.a 
              href="https://wa.me/919392509079"
              target="_blank"
              rel="noreferrer"
              whileHover={{ scale: 1.05 }}
              className="bg-[#25D366] p-3 md:p-4 rounded-2xl mb-4 cursor-pointer flex items-center justify-center w-28 h-28 md:w-40 md:h-40"
            >
            ...
            <p className="text-[#001a3d] font-black tracking-widest text-[13px] mb-1">+91 93925 09079</p>
