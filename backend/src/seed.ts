...
async function main() {
  ...
  const products = [
    ...
    {
      slug: 'natural-ripe-fruits',
      name: 'Natural Ripe Fruits',
      category: 'Kulfis',
      mainImg: '/assets/prod_fruits_1773805497331.png',
      price: 850,
      rating: 4.5,
      reviews: 89,
    ...
    },
    {
      ...
      category: 'Honey',
      mainImg: '/assets/prod_honey_1773805513434.png',
      price: 1200,
      rating: 4.9,
      reviews: 215,
    ...
    {
      slug: 'village-products',
      name: 'Village Products',
      category: 'Grameenam',
      mainImg: '/assets/prod_graminam_1773805557221.png',
      price: 350,
      rating: 4.7,
      reviews: 56,
    ...
    },
    {
      ...
      name: 'Wellness Range',
      category: 'Niramaya',
      mainImg: '/assets/prod_veg_1773805467767.png',
      price: 1500,
      rating: 4.6,
      reviews: 112,
